...
//    lint.log(""+startWithUnderscore + " " + firstLetterIsLowercase+ " " + ivarName.indexOf("_"));
    if(!startWithUnderscore || !firstLetterIsLowercase)
        lint.reportError("Class's '"+lint.ivar_check_last_class_decl+"' ivar '" + lint.displayName + "' should start with underscore and lowercase letter");
}